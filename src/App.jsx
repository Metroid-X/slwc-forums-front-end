  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/topics/new' element={<NewTopicForm props={props} />} />
        <Route path='/forums/:branchName' element={<Forums props={props} />} />
        <Route path='/forums/:branchName/:topicId' element={<Topics props={props} />} />
      </Routes>
    </>
  )
}
